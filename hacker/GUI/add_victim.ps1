...
$WatermarkText2 				 = "Add victim's Adress"
...
$WatermarkText1 				 = "Add victim's PORT"
$textBox2.ForeColor				 = 'DarkGray'
$textBox2.Text					 = $WatermarkText1
...
$Form.controls.AddRange(@($Label1,$Button1,$TextBox2,$TextBox1))
...
{ 
  ...
  Add-Content -Path C:\DuckSploit\victimsIP.txt -Value ($TextBox1.Text)
  Add-Content -Path C:\DuckSploit\victimsPORT.txt -Value ($TextBox2.Text)
  Invoke-Item (powershell "C:\DuckSploit\GUI\main.ps1"))
  Form.Close()
}
}
}
